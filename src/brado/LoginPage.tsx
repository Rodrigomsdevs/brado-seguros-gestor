...
export const LoginPage: React.FC<LoginProps> = ({ onLogin, usuarios }) => {
  ...
  return (
    <div style={{
      ...
      fontFamily: fonts, position: 'relative',
      ...
      {/* Image — full page background, right side */}
      <img
        src={loginBg}
        alt="Proteção e segurança"
        style={{
          position: 'absolute', right: '5%', top: '50%', transform: 'translateY(-50%)',
          width: '45%', maxHeight: '70%', objectFit: 'contain',
      ...
      <div style={{
        ...
        width: 390, marginLeft: '8%',
        background: c.modalBg, borderRadius: 20,
        padding: '36px 30px 30px',
        boxShadow: theme === 'light'
          ? '0 16px 56px rgba(0,0,0,0.14), 0 0 0 1px rgba(0,0,0,0.04)'
